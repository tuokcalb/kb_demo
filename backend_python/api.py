...
from query_modules import get_information, query_database, show_tables
...
@app.get("/get_information_api", response_model=list)
async def get_information_api(table : str):
    result = get_information(table)
    return result
